        ...
        PanelWindow {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    width: centerLayout.implicitWidth + barWindow.s(50)
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: -2
                            Text { text: barWindow.timeStr; Layout.alignment: Qt.AlignHCenter; font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(18); font.weight: Font.Black; color: mocha.blue }
                            Text { text: barWindow.dateStr; Layout.alignment: Qt.AlignHCenter; font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(12); font.weight: Font.Bold; color: mocha.subtext0 }
                        }
